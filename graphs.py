...
def plot_underwater(df, benchmark_ticker):
    ...
    plt.figure()
    plt.plot(o_port_drawdown.index, o_port_drawdown, color='lime', linewidth=1, linestyle='-', label='O_PORTFOLIO')
    plt.plot(e_port_drawdown.index, e_port_drawdown, color='crimson', linewidth=1, linestyle='-', label='E_PORTFOLIO')
